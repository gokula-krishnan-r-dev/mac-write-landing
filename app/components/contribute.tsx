                    ...
                    <div>
                        <span className="flex shrink-0 overflow-hidden rounded-full size-12 relative border-2 border-background bg-muted">
                            <img
                                ...
                                alt="Alice Johnson"
                                src="https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=48&h=48&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NHx8cG9ydHJhaXR8ZW58MHx8MHx8fDA%3D"
                                width={48}
                                height={48}
                            />
                        </span>
                    ...
                    <div>
                        <span className="flex shrink-0 overflow-hidden rounded-full size-12 relative border-2 border-background bg-muted">
                            <img
                                className="aspect-square h-full w-full object-cover"
                                alt="Bob Brown"
                                src="https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=48&h=48&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTh8fHBvcnRyYWl0fGVufDB8fDB8fHww"
                                width={48}
                                height={48}
                            />
                        </span>
                    ...
                    <div>
                        <span className="flex shrink-0 overflow-hidden rounded-full size-12 relative border-2 border-background bg-muted">
                            <img
                                className="aspect-square h-full w-full object-cover"
                                alt="Charlie Davis"
                                src="https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=48&h=48&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTJ8fHBvcnRyYWl0fGVufDB8fDB8fHww"
                                width={48}
                                height={48}
                            />
                        </span>
                    ...
                    <div>
                        <span className="flex shrink-0 overflow-hidden rounded-full size-12 relative border-2 border-background bg-muted">
                            <img
                                className="aspect-square h-full w-full object-cover"
                                alt="Diana Evans"
                                src="https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=48&h=48&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mjh8fHBvcnRyYWl0fGVufDB8fDB8fHww"
                                width={48}
                                height={48}
                            />
                        </span>
                    ...
                    <div>
                        <span className="flex shrink-0 overflow-hidden rounded-full size-12 relative border-2 border-background bg-muted">
                            <img
                                className="aspect-square h-full w-full object-cover"
                                alt="Ethan Ford"
                                src="https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=48&h=48&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MzJ8fHBvcnRyYWl0fGVufDB8fDB8fHww"
                                width={48}
                                height={48}
                            />
                        </span>
